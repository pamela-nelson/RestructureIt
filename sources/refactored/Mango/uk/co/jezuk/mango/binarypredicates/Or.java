...
public class Or<T1, T2> implements uk.co.jezuk.mango.BinaryPredicate<T1, T2> {
    public Or(uk.co.jezuk.mango.BinaryPredicate<T1, T2> pred1, uk.co.jezuk.mango.BinaryPredicate<T1, T2> pred2) {
        p1_ = pred1;
        p2_ = pred2;
    }
