...
public class Xnor<T> implements uk.co.jezuk.mango.Predicate<T> {
    public Xnor(final uk.co.jezuk.mango.Predicate<T> pred1, final uk.co.jezuk.mango.Predicate<T> pred2) {
        p1_ = pred1;
        p2_ = pred2;
    }
